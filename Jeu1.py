...
fenetre = pygame.display.set_mode((Largeur_fenetre, hauteur_fenetre),FULLSCREEN) #Création de la fenêtre. avec ajout de l'argument FULLSCREEN pour mettre en grand écran la fenêtre mais en gardant la taille qui à était défini, soit 1200x(1200*0.8).
