...
def afficher():
    ...
    boutton10=Button(fenetre2,text="Question 10:\n\n Quelles sont les noms et rôles (category et job) des personnes intervenant dans la production du film Return of the Jedi ?",width=80, command=sql10, font="Calibri, 12")
